 ...
 */
final class Version20231206122121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE critere (id INT AUTO_INCREMENT NOT NULL, teste_id INT NOT NULL, score_max DOUBLE PRECISION NOT NULL, score_defaut DOUBLE PRECISION NOT NULL, interpretation_max_texte VARCHAR(255) NOT NULL, interpretation_min_texte VARCHAR(255) NOT NULL, interpretation_max_couleur VARCHAR(7) NOT NULL, interpretation_min_couleur VARCHAR(7) NOT NULL, interpretation_max_image VARCHAR(255) DEFAULT NULL, interpretation_min_image VARCHAR(255) DEFAULT NULL, nom_critere VARCHAR(255) NOT NULL, INDEX IDX_7F6A805380AA0132 (teste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE critere_solution (id INT AUTO_INCREMENT NOT NULL, tentative_id INT DEFAULT NULL, critere_id INT DEFAULT NULL, point DOUBLE PRECISION NOT NULL, INDEX IDX_7CA5386DD78CE477 (tentative_id), INDEX IDX_7CA5386D9E5F45AB (critere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tentative (id INT AUTO_INCREMENT NOT NULL, teste_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date_tentative DATETIME NOT NULL, INDEX IDX_DBC382F980AA0132 (teste_id), INDEX IDX_DBC382F9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_teste (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
