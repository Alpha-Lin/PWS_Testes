 ...
 */
final class Version20231120232653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tentative (id INT AUTO_INCREMENT NOT NULL, teste_id INT NOT NULL, user_id INT DEFAULT NULL, id_tentative INT NOT NULL, date_tentative DATETIME NOT NULL, INDEX IDX_DBC382F980AA0132 (teste_id), INDEX IDX_DBC382F9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE teste (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, id_teste INT NOT NULL, image_teste LONGBLOB DEFAULT NULL, INDEX IDX_E6B4490FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
