 ...
 */
final class Version20231201103607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teste (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type_teste_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, image_teste VARCHAR(255) NOT NULL, INDEX IDX_E6B4490FA76ED395 (user_id), INDEX IDX_E6B4490F4D5526CE (type_teste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
